...
_lr_productions = [
  ...
  ('iteration_statement -> FOR LPAREN expression SEMICOLON expression SEMICOLON expression RPAREN compound_statement','iteration_statement',9,'p_iteration_statement','d_pound.py',169),
  ('assignment_statement -> IDENTIFIER ASSIGN expression SEMICOLON','assignment_statement',4,'p_assignment_statement','d_pound.py',177),
  ('declaration_statement -> VAR IDENTIFIER ASSIGN expression SEMICOLON','declaration_statement',5,'p_declaration_statement','d_pound.py',182),
  ('expression -> expression ADD expression','expression',3,'p_expression','d_pound.py',188),
  ('expression -> expression SUB expression','expression',3,'p_expression','d_pound.py',189),
  ('expression -> expression MULT expression','expression',3,'p_expression','d_pound.py',190),
  ('expression -> expression DIV expression','expression',3,'p_expression','d_pound.py',191),
  ('expression -> expression EQUAL expression','expression',3,'p_expression','d_pound.py',192),
  ('expression -> expression NOT_EQUAL expression','expression',3,'p_expression','d_pound.py',193),
  ('expression -> expression GREATER_THAN expression','expression',3,'p_expression','d_pound.py',194),
  ('expression -> expression LESS_THAN expression','expression',3,'p_expression','d_pound.py',195),
  ('expression -> expression GREATER_THAN_OR_EQUAL expression','expression',3,'p_expression','d_pound.py',196),
  ('expression -> expression LESS_THAN_OR_EQUAL expression','expression',3,'p_expression','d_pound.py',197),
  ('expression -> INTEGER','expression',1,'p_expression','d_pound.py',198),
  ('expression -> FLOAT','expression',1,'p_expression','d_pound.py',199),
  ('expression -> STRING','expression',1,'p_expression','d_pound.py',200),
  ('expression -> BOOLEAN','expression',1,'p_expression','d_pound.py',201),
  ('expression -> IDENTIFIER','expression',1,'p_expression','d_pound.py',202),
]
